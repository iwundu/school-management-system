...
if(isset($_POST['submit'])){
    ...
    $steacher = checker($conn,$_POST['steacher']);
    ...
    if(empty($sname)){
     ...
     if(empty($steacher)){
         $error .= '<div class="alert alert-danger" role="alert"> Name  of Subject Teacher is Required!
</div>';
    }
    if($error != ""){
         ...
         $error .= '<div class="alert alert-danger" role="alert"> There were error(s)!'.$error.'
            ...
            $query = "UPDATE subject set name = '$sname', teacher = '$steacher', class = '$class' WHERE name = '$sname' LIMIT 1";
            $result = mysqli_query($conn,$query) or die(mysqli_error($conn));
            $error .= '<div class="alert alert-success" role="alert"> Subject Edited Successfully!
</div>';
    }
...
<html>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                 <li><a href="view_subject.php"><button class="btn btn-success">View Subject</button></a></li>
    ...
    <input type="text" class="form-control" name="steacher" aria-describedby="emailHelp" placeholder="Enter Teacher Name">
            </div>
   <div class="form-group">
    ...
    <select class="form-control" name="class">
      ...
      <option>SS3D</option>
                  ...
                  <button type="submit" class="btn btn-primary btn-lg" name="submit">Edit Subject</button>
                  <?php echo $error; ?>
</form>
