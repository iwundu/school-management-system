...
$result = mysqli_query($conn,"SELECT * FROM student WHERE(`fname` LIKE '%".$search."%') ORDER BY `class` ASC ") or die(mysqli_error());
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="add_student.php"><button class="btn btn-success">Add Student</button></a></li>
                         ...
                         <tr>
                          ...
                          <td><?php echo $row['uname']; ?></td>
                            ...
                            <td><?php echo $row['class']; ?></td>
                             <td style="background-color:skyblue"><a href="edit_student.php"><span class="glyphicon glyphicon-edit" style="color:brown;font-size:16px;"></span></a>
                                 <a href="view_student.php"><span class="glyphicon glyphicon-user" style="color:green;font-size:16px;"></span></a>
                             <a href="delete_student.php"><span class="glyphicon glyphicon-remove" style="color:red;font-size:16px;"></span></a>
                             </td>
                        </tr>
                        </table>
                    <?php echo $error; ?>
