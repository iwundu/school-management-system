...
//INPUT STRINGS //
    ...
    if(empty($subject)){
        $error .= '<div class="alert alert-danger" role="alert">subject Number is Required!
</div>';
    }
...
'</div>';
        ...
        $query = "INSERT INTO `teachers`(fname,uname,email,gender,password,address,phone,img,class,subject)
        VALUES('$fname','$uname','$email','$gender','$password','$address','$phone','$target_file','$class','$subject')";
...
<html>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="teacher.php"><button class="btn btn-success">View teacher</button></a></li>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="Name" aria-describedby="emailHelp" placeholder="Enter subject" name="subject">
      </div>
                  <div class="form-group">
    <label for="exampleInputEmail1">Class</label>
    <input type="text" class="form-control" id="Name" aria-describedby="emailHelp" placeholder="Enter class" name="class">
      </div>
