                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="adminHome.php"><?php echo $row['uname']; ?></a></li>
                  ...
                  <th>Operations</th>
                         ...
                         <tr>
                          ...
                          <td><?php echo $row['subjects']; ?></td>
                             ...
                             <td style="background-color:skyblue"><a href="edit_subject.php"><span class="glyphicon glyphicon-edit" style="color:brown;font-size:16px;"></span></a>
                                 <a href="view_subject.php"><span class="glyphicon glyphicon-user" style="color:green;font-size:16px;"></span></a>
                             <a href="delete_subject.php"><span class="glyphicon glyphicon-remove" style="color:red;font-size:16px;"></span></a>
                             </td>
                        </tr>
                        </table>
                    <?php echo $error; ?>
