...
$result = mysqli_query($conn,"SELECT * FROM teachers WHERE(`fname` LIKE '%".$search."%') ORDER BY `fname` ASC ") or die(mysqli_error($conn));
            ...
            <div id="content">
                ...
                <div class="container" style="padding-top:3rem; padding-bottom:1rem;" id="profile">
                    <table class="table table-bordered table-striped table-hover">
                        <tr>
                            <thead><b class="lead" style="font-size:2rem">List Teachers</b></thead>
                            <thead>
                         ...
                         <tr>
                          ...
                          <td><?php echo $row['uname']; ?></td>
                            ...
                            <td><?php echo $row['phone']; ?></td>
                             <td style="background-color:skyblue"><a href="edit_teacher.php"><span class="glyphicon glyphicon-edit" style="color:brown;font-size:16px;"></span></a>
                                 <a href="view_teacher.php"><span class="glyphicon glyphicon-user" style="color:green;font-size:16px;"></span></a>
                             <a href="delete_teacher.php"><span class="glyphicon glyphicon-remove" style="color:red;font-size:16px;"></span></a>
                             </td>
                        </tr>
                        </table>
                    <?php echo $error; ?>
