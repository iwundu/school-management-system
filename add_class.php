...
if(isset($_POST['submit'])){
    ...
    if($error != ""){
         ...
         $error .= '<div class="alert alert-danger" role="alert"> There were error(s)!'.$error.'
            ...
            $query = "INSERT INTO class (class_name,subjects,class_teacher) VALUES('$class','$sname','$cteacher')";
            $result = mysqli_query($conn,$query) or die(mysqli_error($conn));
            $error .= '<div class="alert alert-success" role="alert"> Class Added!
</div>';
    }
   ...
   <div class="form-group">
    ...
    <select class="form-control" name="class">
      ...
      <option>SS3D</option>
            ...
            <button type="submit" class="btn btn-primary btn-lg" name="submit">Add Class</button>
                  <?php echo $error; ?>
</form>
